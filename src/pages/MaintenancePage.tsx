...
const MaintenancePage = () => (
  <Layout>
    <SEOHead title="AC Maintenance & Tune-Up | AC Assurance Cooling & Heating" description="Preventive AC maintenance and tune-ups in Southwest Florida. Extend system life, lower bills, prevent breakdowns. Call (239) 365-3090." />
    <ServicePageShell
      ...
      heroImage={heroImg}
      heroAlt="AC Assurance technician performing a maintenance tune-up"
