        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <div className="w-32 h-32 rounded-lg bg-muted flex items-center justify-center shrink-0 text-muted-foreground text-xs text-center border border-border">
                PHOTO PLACEHOLDER — Owner/Team
              </div>
              <div>
                <h2 className="text-2xl font-heading font-bold text-foreground mb-3">Owner-Operated. Quality-Driven.</h2>
            ...
            <div>
              <h2 className="text-2xl font-heading font-bold text-foreground mb-4">Why Homeowners Trust Us</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={item.title} className="flex items-start gap-3 p-4 rounded-lg bg-muted">
            ...
            <div>
              <h2 className="text-2xl font-heading font-bold text-foreground mb-4">Areas We Serve</h2>
              <p className="text-foreground leading-relaxed">
          ...
          <div>
            <div className="sticky top-28 space-y-6">
              <div className="bg-card border border-border rounded-lg p-6 text-center">
                <h3 className="font-heading font-bold text-lg text-foreground mb-3">Ready to Get Started?</h3>
                <p className="text-sm text-muted-foreground mb-5">Schedule a free estimate or call us to discuss your HVAC needs.</p>
                <div className="flex flex-col gap-3">
                  <Button asChild size="lg" className="w-full brand-gradient-teal text-primary-foreground hover:opacity-90">
              ...
              <div className="bg-muted rounded-lg p-5">
                <div className="grid grid-cols-1 gap-3 text-center">
                  <div>
                    <div className="text-2xl font-heading font-extrabold text-accent">24/7</div>
                    <div className="text-xs text-muted-foreground">Emergency Service</div>
                  </div>
                  <div>
                    <div className="text-2xl font-heading font-extrabold text-accent">9</div>
                    <div className="text-xs text-muted-foreground">HVAC Services Offered</div>
                  </div>
                  <div>
                    <div className="text-2xl font-heading font-extrabold text-accent">7</div>
