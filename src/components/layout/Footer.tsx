      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        <div>
          ...
          <div className="flex items-center gap-2 mt-3">
            <img src={bbbLogo} alt="BBB Accredited Business" <img src={bbbLogo} alt="BBB Accredited Business" className="h-10 w-auto brightness-0 invert opacity-70" width={40} height={40} /> width={32} height={32} />
